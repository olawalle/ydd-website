            ...
            <div class="container">
              <div class="row">
                <div class="col-md-4 col-sm-5" id="sidebar-col">
                  <div
                    id="event_counter-1"
                    class="widget sidebar-widget widget_event_counter"
                  >
                    <section class="upcoming-event format-standard event-list-item event-dynamic">
                      ...
                      >
                        <img
                          ...
                          class="attachment-600x400 size-600x400 wp-post-image"
                          alt=""
                        />
                      </a>
                      <div class="upcoming-event-content">
                        <span class="label label-primary upcoming-event-label">
                          Next coming event
                        </span>
                        <div
                          id="event-counter-event_counter-1"
                          class="counter clearfix"
                        ...
                        <span class="meta-data">
                          On <span class="event-date">April 19, 2020</span> at{" "}
                          <span class="event-time">3:00 pm</span> at
                        </span>
                      ...
                      <div class="upcoming-event-footer">
                        ...
                        <ul class="action-buttons">
                          ...
                          <li title="Get directions" class="hidden-xs">
                            <a
                              href="#"
                              class="cover-overlay-trigger event-direction-link"
                            >
                      ...
                      <div class="event-list-item-info">
                        ...
                        <div class="lined-info">
                          <span class="meta-data">
                            ...
                            <span class="event-time">3:00 pm - 8:00 pm</span>{" "}
            ...
            <div class="container">
              ...
              <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="very-latest-post format-standard">
                        ...
                        <div class="meta-data">
                          by <a href="author/imicreation/index.html">Admin</a>{" "}
                          on January 24, 2018 in{" "}
                          <a href="category/featured/index.html">Featured</a>,{" "}
                            ...
                            <div class="col-md-12">
                              <a href="2018/01/24/self-hosted-audio-post-example/index.html">
                                <strong class="post-title">
                                  Self hosted audio post example
                                </strong>
                              </a>
                              <div class="meta-data">
                                by{" "}
                                ...
                                ,{" "}
                                <a href="category/general/index.html">
                                  General
                                </a>
                                ,{" "}
                                <a href="category/uncategorized/index.html">
                                ...
                                , <a href="category/unity/index.html">Unity</a>,{" "}
                                <a href="category/videos/index.html">Videos</a>
                              </div>
                              <p>
                                Lorem ipsum dolor sit amet, consectetur
                                adipiscing elit. Nulla convallis egestas
                                rhoncus.
                              </p>{" "}
                              <p>
                                <a
                        ...
                        <li class="format-standard">
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <p>
                                <a
                                  href="2018/01/24/gallery-post-format/index.html"
                                  class="basic-link"
                                >
                                  Continue reading{" "}
                                  <i class="fa fa-angle-right"></i>
                        ...
                        <li class="format-standard">
                          <div class="row">
                            <div class="col-md-12">
                              ...
                              <p>
                                <a
                                  href="2018/01/24/soundcloud-audio-post/index.html"
                                  class="basic-link"
                                >
                                  Continue reading{" "}
                                  <i class="fa fa-angle-right"></i>
                ...
                <div class="col-md-4">
                  <div
                    id="sermon_list-1"
                    class="widget sidebar-widget widget_sermon_list"
                  >
                    ...
                    <ul>
                      <li class="most-recent-sermon clearfix">
                        ...
                        <div class="latest-sermon-content">
                          <h4>
                            <a href="index40c6.html?sermon=the-difference-maker">
            ...
            <div class="site-footer-top">
              <div class="row">
                <div class="col-md-4 col-sm-4 widget footer-widget widget_text">
                  ...
                  <div class="textwidget">
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Nulla convallis egestas rhoncus. Donec facilisis fermentum
                      sem, ac viverra. Lorem ipsum dolor sit amet, consectetur
                      adipiscing elit. Nulla convallis egestas rhoncus. Donec
                ...
                <div class="col-md-4 col-sm-4 widget footer-widget widget_twitter_feeds">
                  ...
                  <ul>
                    <li>
                      <i class="fa fa-twitter"></i> RT{" "}
                      <a href="http://www.twitter.com/pulte">@pulte</a>: I’m
                      going give $3,000 to someone random who retweets this
                      tweet in the next 72 hours (must be following me so I can
                      dm you. Will…
                      <span class="date">Mar. 26, 2020</span>
                    </li>
                    <li>
                      <i class="fa fa-twitter"></i> RT{" "}
                      <a href="http://www.twitter.com/MaryZai">@MaryZai</a>:
                      Ever since I started working, one thing becomes clearer
                      each passing day: It’s not money I’m after. It’s the
                      freedom to live…
            ...
            <div class="site-footer-bottom">
              <div class="row">
                <div class="col-md-6 col-sm-6 copyrights-coll">
                  © 2019 Adore Church. All Rights Reserved{" "}
                </div>
